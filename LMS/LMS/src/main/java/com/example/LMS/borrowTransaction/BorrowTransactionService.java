...
import com.example.LMS.borrower.Borrower;
...
import com.example.LMS.borrower.BorrowerRepository;
...
public class BorrowTransactionService {
    ...
    public Page<BorrowTransactionDTO> getTransactionHistory(UUID borrowerId, TransactionStatus status, Pageable pageable) {
        Page<BorrowTransaction> transactions;

        if (status != null) {
            transactions = borrowTransactionRepository.findByBorrowerIdAndStatus(borrowerId, status, pageable);
        } else {
            transactions = borrowTransactionRepository.findByBorrowerId(borrowerId, pageable);
        }
